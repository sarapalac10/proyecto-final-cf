...
const Donaciones = () => {
    return (
        <div className={styles.container}>
            ...
            <p>Tu apoyo permite que más gatitos encuentren un hogar lleno de amor</p>
            ...
            <div className={styles.historiasExito}>
                <p>Gracias a personas como tú, hemos rescatado más de 100 gatitos en los 2 años de existencia del refugio.</p>
            ...
            <h2>Cómo donar</h2>
            <p>Puedes donar a través de nuestra página de PayPal o a través de trasnferencia por varios canales.</p>
